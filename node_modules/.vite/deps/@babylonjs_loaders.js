...
GLTFLoader2.RegisterExtension(NAME5, (loader) => new EXT_texture_avif(loader));
...
var KHR_draco_mesh_compression = class {
  ...
  constructor(loader) {
    ...
    this._loader = loader;
    this.enabled = DracoCompression.DecoderAvailable && this._loader.isExtensionUsed(NAME6);
  }
  /** @internal */
  dispose() {
...
GLTFLoader2.RegisterExtension(NAME6, (loader) => new KHR_draco_mesh_compression(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_lights_punctual.js
var NAME7 = "KHR_lights_punctual";
...
GLTFLoader2.RegisterExtension(NAME7, (loader) => new KHR_lights(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_pbrSpecularGlossiness.js
var NAME8 = "KHR_materials_pbrSpecularGlossiness";
...
GLTFLoader2.RegisterExtension(NAME8, (loader) => new KHR_materials_pbrSpecularGlossiness(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_unlit.js
var NAME9 = "KHR_materials_unlit";
...
GLTFLoader2.RegisterExtension(NAME9, (loader) => new KHR_materials_unlit(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_clearcoat.js
var NAME10 = "KHR_materials_clearcoat";
...
GLTFLoader2.RegisterExtension(NAME10, (loader) => new KHR_materials_clearcoat(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_iridescence.js
var NAME11 = "KHR_materials_iridescence";
...
GLTFLoader2.RegisterExtension(NAME11, (loader) => new KHR_materials_iridescence(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_anisotropy.js
var NAME12 = "KHR_materials_anisotropy";
...
GLTFLoader2.RegisterExtension(NAME12, (loader) => new KHR_materials_anisotropy(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_emissive_strength.js
var NAME13 = "KHR_materials_emissive_strength";
...
GLTFLoader2.RegisterExtension(NAME13, (loader) => new KHR_materials_emissive_strength(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_sheen.js
var NAME14 = "KHR_materials_sheen";
...
GLTFLoader2.RegisterExtension(NAME14, (loader) => new KHR_materials_sheen(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_specular.js
var NAME15 = "KHR_materials_specular";
...
GLTFLoader2.RegisterExtension(NAME15, (loader) => new KHR_materials_specular(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_ior.js
var NAME16 = "KHR_materials_ior";
...
GLTFLoader2.RegisterExtension(NAME16, (loader) => new KHR_materials_ior(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_variants.js
var NAME17 = "KHR_materials_variants";
var KHR_materials_variants = class _KHR_materials_variants {
  ...
  static SelectVariant(rootMesh, variantName) {
    const extensionMetadata = this._GetExtensionMetadata(rootMesh);
    if (!extensionMetadata) {
      throw new Error(`Cannot select variant on a glTF mesh that does not have the ${NAME17} extension`);
    }
  ...
  static Reset(rootMesh) {
    const extensionMetadata = this._GetExtensionMetadata(rootMesh);
    if (!extensionMetadata) {
      throw new Error(`Cannot reset on a glTF mesh that does not have the ${NAME17} extension`);
    }
  ...
  static GetLastSelectedVariant(rootMesh) {
    const extensionMetadata = this._GetExtensionMetadata(rootMesh);
    if (!extensionMetadata) {
      throw new Error(`Cannot get the last selected variant on a glTF mesh that does not have the ${NAME17} extension`);
    }
  ...
  static _GetExtensionMetadata(rootMesh) {
    var _a, _b;
    return ((_b = (_a = rootMesh == null ? void 0 : rootMesh._internalMetadata) == null ? void 0 : _a.gltf) == null ? void 0 : _b[NAME17]) || null;
  }
  /** @internal */
  onLoading() {
    const extensions = this._loader.gltf.extensions;
    ...
    return GLTFLoader2.LoadExtensionAsync(context, primitive, this.name, (extensionContext, extension) => {
      ...
      promises.push(this._loader._loadMeshPrimitiveAsync(context, name, node, mesh, primitive, (babylonMesh) => {
        ...
        if (babylonMesh instanceof Mesh) {
          ...
          const gltf = metadata.gltf = metadata.gltf || {};
          const extensionMetadata = gltf[NAME17] = gltf[NAME17] || { lastSelected: null, original: [], variants: {} };
          ...
          for (let mappingIndex = 0; mappingIndex < extension.mappings.length; ++mappingIndex) {
            ...
            promises.push(this._loader._loadMaterialAsync(`#/materials/${mapping.material}`, material, babylonMesh, babylonDrawMode, (babylonMaterial) => {
              for (let mappingVariantIndex = 0; mappingVariantIndex < mapping.variants.length; ++mappingVariantIndex) {
                ...
                const variant = ArrayItem.Get(`/extensions/${NAME17}/variants/${variantIndex}`, this._variants, variantIndex);
                ...
                babylonMesh.onClonedObservable.add((newOne) => {
                  ...
                  if (root && metadata2 === _KHR_materials_variants._GetExtensionMetadata(root)) {
                    ...
                    newRoot._internalMetadata.gltf[NAME17] = { lastSelected: null, original: [], variants: {} };
                    for (const original of metadata2.original) {
                      newRoot._internalMetadata.gltf[NAME17].original.push({
                        mesh: original.mesh,
                    ...
                    for (const key in metadata2.variants) {
                      if (Object.prototype.hasOwnProperty.call(metadata2.variants, key)) {
                        newRoot._internalMetadata.gltf[NAME17].variants[key] = [];
                        for (const variantEntry of metadata2.variants[key]) {
                          newRoot._internalMetadata.gltf[NAME17].variants[key].push({
                    ...
                    metadata2 = newRoot._internalMetadata.gltf[NAME17];
                  }
...
GLTFLoader2.RegisterExtension(NAME17, (loader) => new KHR_materials_variants(loader));
...
var NAME18 = "KHR_materials_transmission";
...
GLTFLoader2.RegisterExtension(NAME18, (loader) => new KHR_materials_transmission(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_diffuse_transmission.js
var NAME19 = "KHR_materials_diffuse_transmission";
...
GLTFLoader2.RegisterExtension(NAME19, (loader) => new KHR_materials_diffuse_transmission(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_volume.js
var NAME20 = "KHR_materials_volume";
...
GLTFLoader2.RegisterExtension(NAME20, (loader) => new KHR_materials_volume(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_materials_dispersion.js
var NAME21 = "KHR_materials_dispersion";
...
GLTFLoader2.RegisterExtension(NAME21, (loader) => new KHR_materials_dispersion(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_mesh_quantization.js
var NAME22 = "KHR_mesh_quantization";
...
GLTFLoader2.RegisterExtension(NAME22, (loader) => new KHR_mesh_quantization(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_basisu.js
var NAME23 = "KHR_texture_basisu";
...
GLTFLoader2.RegisterExtension(NAME23, (loader) => new KHR_texture_basisu(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_texture_transform.js
var NAME24 = "KHR_texture_transform";
...
GLTFLoader2.RegisterExtension(NAME24, (loader) => new KHR_texture_transform(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/KHR_xmp_json_ld.js
var NAME25 = "KHR_xmp_json_ld";
...
GLTFLoader2.RegisterExtension(NAME25, (loader) => new KHR_xmp_json_ld(loader));
...
var NAME26 = "KHR_animation_pointer";
...
var KHR_animation_pointer = class {
   ...
   */
  get enabled() {
    return this._loader.isExtensionUsed(NAME26);
  }
  /** @internal */
  dispose() {
    this._loader = null;
...
GLTFLoader2.RegisterExtension(NAME26, (loader) => new KHR_animation_pointer(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_audio_emitter.js
var NAME27 = "MSFT_audio_emitter";
...
GLTFLoader2.RegisterExtension(NAME27, (loader) => new MSFT_audio_emitter(loader));
...
GLTFLoader2.RegisterExtension(NAME28, (loader) => new MSFT_lod(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_minecraftMesh.js
var NAME29 = "MSFT_minecraftMesh";
...
GLTFLoader2.RegisterExtension(NAME29, (loader) => new MSFT_minecraftMesh(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/MSFT_sRGBFactors.js
var NAME30 = "MSFT_sRGBFactors";
...
GLTFLoader2.RegisterExtension(NAME30, (loader) => new MSFT_sRGBFactors(loader));
...
GLTFLoader2.RegisterExtension(NAME31, (loader) => new KHR_interactivity(loader));

// node_modules/@babylonjs/loaders/glTF/2.0/Extensions/ExtrasAsMetadata.js
var NAME32 = "ExtrasAsMetadata";
...
GLTFLoader2.RegisterExtension(NAME32, (loader) => new ExtrasAsMetadata(loader));
